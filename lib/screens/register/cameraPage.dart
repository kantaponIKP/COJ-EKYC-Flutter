...
// crossAxisAlignment: CrossAxisAlignment.center, //Center Column contents horizontally,
  ...
  Future<void> returnToRegisterPage(String path) async {
  ...
  void onTakePictureButtonPressed() {
    ...
    takePicture().then((String filePath) async {
      if (mounted) {
        ...
        // final imageRotated =
        //     await File(filePath).writeAsBytes(img.encodeJpg(orientedImage));
        // print(filePath);
        // print("imageRotate*************************");
        // print(imageRotated.path);
        print(filePath);
        final fixedFile = await fixExifRotation(filePath);
        print("finish rotate");
        ...
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (BuildContext context) =>
                    PreviewPhoto(path: fixedFile.path)));
      }
    });
  }
